...
package com.cooee.virtualapk.internal;
...
public class VAInstrumentation extends Instrumentation implements Handler.Callback {
    ...
    public ActivityResult execStartActivity(
        ...
        Log.i(TAG, "realExecStartActivity start");
        ActivityResult result = realExecStartActivity(who, contextThread, token, target,
                    intent, requestCode, options);
        Log.i(TAG, "realExecStartActivity result = " + result);
        return result;
    ...
    public Activity newActivity(ClassLoader cl, String className, Intent intent) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        try {
            ...
            if (targetClassName != null) {
            	Log.i(TAG, "run --> 1" + "classLoader = " + plugin.getClassLoader() + ",targetClassName = " + targetClassName +",intent = " + intent.toString());
